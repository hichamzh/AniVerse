...
const HeroSlider = () => {
  ...
  if (loading || !anime) {
    return <div className="w-full h-72 bg-gray-300 animate-pulse rounded-xl mb-4" />;
  }

  return (
    <div className="relative w-full h-72 mb-4 rounded-xl overflow-hidden shadow-lg">
      <img
