              ...
              >
                <div className="relative aspect-2/3 rounded-lg overflow-hidden border border-slate-800 transition-transform duration-300 group-hover:scale-95">
                  ...
                  <div className="hidden absolute inset-0 bg-linear-to-t from-slate-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 lg:flex items-end p-3">
                    <Link to={`/anime/${anime.mal_id}`} className="w-full py-2 bg-indigo-600 text-xs text-center font-bold rounded hover:bg-indigo-500 transition-colors cursor-pointer">
                      SEE MORE
                    </Link>
                  </div>
                </div>
